...
from _names import names_old

c = ChainCalculator(new_interps=True)


# sigma8
m_s8 = ["yxgxksig_hmc_Ahmc", "gxk", "yxgxk_b_gauss", "yxgxk_b08"]
c.plot_tomo(m_s8, "sigma8", keep_on=True)

# gastrophysics
m_bh = ["yxgxksig_hmc_Ahmc", "yxgxk_b_gauss", "yxgxk_mf_despali16"]
c.plot_tomo(m_bh, "ygk_mass_bias", keep_on=True)
c.plot_tomo(m_bh, "bPe", keep_on=True)
c.plot_tomo(m_bh, "Omth", keep_on=True)

# systematics
m_sys = ["yxgxksig_hmc_Ahmc", "yxgxksig", "yxgxksig_decouple_Ahmc",
         "yxgxk_szdeproj", "yxgxk_ns_independent"]
c.plot_tomo(m_sys, "sigma8", keep_on=True)
c.plot_tomo(m_sys, "ygk_mass_bias", keep_on=True)
c.plot_tomo(m_sys, "bPe", keep_on=True)

# triangles
m_tri = ["yxgxksig", "yxgxk_b_gauss"]
...
c.plot_best_fit("gxk", keep_on=True)
c.plot_best_fit("yxgxk_b08", keep_on=True)
